...
public class CommentServiceTest {
    ...
    public void getComments() {
        //given
        doReturn(comments()).when(commentRepository).findAllByPostIdAndRefCommentIsNullOrderByCreatedAtDesc(new PostId(1L));
        ...
        verify(commentRepository, times(1)).findAllByPostIdAndRefCommentIsNullOrderByCreatedAtDesc(any(PostId.class));
    }
