package com.monkey.context.user.repository;
...
import com.monkey.context.user.dto.user.UserProfileSaveDto;
import com.monkey.context.user.dto.user.UserProfileUpdateDto;
import com.monkey.context.user.enums.OauthType;
import com.monkey.context.user.infra.repository.UserRepository;
...
public class UserRepositoryTest {
    ...
    public void setProfile() {
        ...
        //then
        User result = userRepository.findById(new UserId("test")).orElseThrow();
